...
import { Eye, EyeOff, Lock, User as UserIcon, Bed, Monitor, Users, ShieldCheck } from "lucide-react";
      ...
      <div className="w-full max-w-6xl bg-white rounded-3xl overflow-hidden shadow-2xl grid lg:grid-cols-2">
        ...
        <div className="p-8 lg:p-12 flex flex-col justify-center bg-white">
          <div className="max-w-sm w-full mx-auto">
            ...
            <h1 className="mt-4 text-2xl font-extrabold text-secondary text-center">Welcome Back!</h1>
            <p className="text-sm text-muted-foreground text-center">Sign in to your account to continue</p>
            ...
            <form onSubmit={onSubmit} className="mt-6 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                <button type="button" className="h-11 rounded-xl border border-border font-semibold text-sm inline-flex items-center justify-center gap-2 hover:bg-muted">
                  <GoogleIcon /> Google
                </button>
                <button type="button" className="h-11 rounded-xl border border-border font-semibold text-sm inline-flex items-center justify-center gap-2 hover:bg-muted">
              ...
              <p className="text-center text-xs text-muted-foreground">
                Don't have an account? <a href="#" className="text-primary font-semibold">Contact Administrator</a>
              </p>
            </form>
          </div>
        </div>
...
function GoogleIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 48 48">
      <path fill="#FFC107" d="M43.6 20.5H42V20H24v8h11.3C33.7 32.9 29.3 36 24 36c-6.6 0-12-5.4-12-12s5.4-12 12-12c3 0 5.8 1.1 7.9 3l5.7-5.7C34.1 6.1 29.3 4 24 4 12.9 4 4 12.9 4 24s8.9 20 20 20 20-8.9 20-20c0-1.3-.1-2.3-.4-3.5z"/>
      <path fill="#FF3D00" d="M6.3 14.7l6.6 4.8C14.7 16.1 19 13 24 13c3 0 5.8 1.1 7.9 3l5.7-5.7C34.1 6.1 29.3 4 24 4 16.3 4 9.6 8.3 6.3 14.7z"/>
      <path fill="#4CAF50" d="M24 44c5.2 0 9.9-2 13.4-5.2l-6.2-5.2c-2 1.4-4.5 2.4-7.2 2.4-5.2 0-9.6-3.1-11.3-7.7l-6.5 5C9.4 39.6 16.1 44 24 44z"/>
      <path fill="#1976D2" d="M43.6 20.5H42V20H24v8h11.3c-.8 2.3-2.3 4.2-4.1 5.6l6.2 5.2C40.7 35.4 44 30.1 44 24c0-1.3-.1-2.3-.4-3.5z"/>
    </svg>
  );
}
